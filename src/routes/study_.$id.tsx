  ...
  createFileRoute(
    ...
    head: () => ({
      meta: [
        {
          title:
            "Study Material — Learnova",
        },
        {
          name:
            "description",
          content:
            "Open a Learnova study document, summary, flashcards and quiz.",
        },
        {
          property:
            "og:title",
...
/*
 * Same wording as the Study hub's statusLabel()
        ...
        {stillResolving ? (
          ...
          <div className="mt-6 flex flex-col items-center gap-3 rounded-2xl border border-destructive/30 bg-destructive/10 p-10 text-center">
            ...
            <div className="text-sm font-semibold text-foreground">
              {!isOnline
                ? "You're offline, and this document wasn't saved for offline viewing."
                : "We couldn't load this material."}
            </div>
