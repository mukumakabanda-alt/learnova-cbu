      ...
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            ...
            className="hidden items-center gap-1.5 rounded-lg px-2.5 py-2 text-xs font-semibold text-muted-foreground transition-colors hover:bg-muted hover:text-foreground sm:inline-flex"
          >
          ...
          {user ? (
            ...
            <>
              ...
              <Link
                to="/auth"
                className="inline-flex items-center gap-1.5 rounded-lg bg-primary px-3.5 py-2 text-sm font-semibold text-primary-foreground shadow-soft transition-transform hover:scale-[1.02] active:scale-100"
              >
                Get started
              </Link>
            </>
        ...
        {items.map(({ to, label, icon: Icon }) => {
          ...
          return (
            ...
            >
              ...
              />
              <span className={active ? "drop-shadow-[0_0_6px_oklch(0.7_0.16_48_/_0.7)]" : ""}>
                {label}
              </span>
            </Link>
          );
  ...
  return (
    <footer className="border-t border-border/60 bg-surface-muted">
      <div className="mx-auto grid max-w-6xl gap-8 px-4 py-12 sm:px-6 md:grid-cols-4">
        <div className="md:col-span-2">
          ...
          <p className="mt-3 max-w-sm text-sm text-muted-foreground">
            Built by a CBU student, for CBU students — fast, focused, and organised the way you'd
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
            ...
            <li>
              <Link to="/study" className="hover:text-foreground">
                Study catalogue
              </Link>
            </li>
            <li>
      ...
      <div className="flex flex-col items-center gap-1 border-t border-border/60 py-4 text-center text-xs text-muted-foreground">
        ...
        <Link
          to="/admin"
          className="text-[10px] text-muted-foreground/40 transition-colors hover:text-copper"
        >
          ·
        </Link>
      </div>
